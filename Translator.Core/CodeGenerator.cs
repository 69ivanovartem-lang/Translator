namespace Translator.Core
{
    ...
    public static class CodeGenerator
    {
        ...
        {
            AddInstruction("PRINT_BUF DB 10 DUP (?)");
        ...
        {
            nameTable.GetIdentifiers().ForEach(identifier =>
            {
        ...
        /// <summary>
        /// Генерация инструкций XOR
        /// </summary>
        public static void AddXorInstruction()
        {
            AddInstruction("pop bx");
            AddInstruction("pop ax");
        ...
        /// </summary>
        public static void AddExtractValueInstruction(string varName)
        {
            AddInstruction($"mov ax, {varName}");
            AddInstruction("push ax");
        }
